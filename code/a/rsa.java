...
class rsa {
    ...
    public static byte[] decrypt(String data, String base64PrivateKey) throws IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
    ...
    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
        try {
            ...
            byte[] encryptedString = encrypt("Dhiraj is the author".getBytes(), publicKey);
            System.out.println(encryptedString[0]);
            byte[] decryptedString = rsa.decrypt(encryptedString, getPrivateKey(privateKey));
            System.out.println(decryptedString[0]);
        } catch (NoSuchAlgorithmException e) {
